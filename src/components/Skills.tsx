...
const skillCategories = [
    ...
    },
    {
        ...
        items: ['React.js', 'Node.js', 'Next.js', 'Express', 'HTML', 'CSS', 'Bootstrap', 'TailwindCSS']
    },
    {
        category: 'Tools & Platforms',
        items: ['MySQL', 'MongoDB', 'Git', 'GitHub', 'Vercel', 'Render', 'Cloudinary']
    },
    {
        category: 'Core CS Fundamentals',
        items: ['Data Structures and Algorithms', 'Object-Oriented Programming', 'Database Management System', 'Operating Systems', 'Computer Networks']
    },
    {
        category: 'Soft Skills',
        items: ['Time Management', 'Leadership', 'Problem-Solving', 'Adaptability']
    }
];
            ...
            <div className="absolute top-12 left-0 w-full overflow-hidden flex whitespace-nowrap pointer-events-none select-none mask-edges">
                <div className="flex animate-marquee min-w-full">
                    {[...allSkills, ...allSkills, ...allSkills].map((item, idx) => (
                        <span key={idx} className="mx-4 text-4xl font-extrabold text-zinc-900/20 tracking-tighter uppercase">
                            {item}
                        </span>
                    ))}
                </div>
